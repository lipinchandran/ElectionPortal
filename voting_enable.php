<?php
  ...
  {
    $updatequery="update admin set voting='1';";
    $updateresult=mysql_query($updatequery);
    
  }
  if (isset($_POST['btndisable'])) 
  {
    $query="update admin set voting='0';";
...
<html lang="en">
  <head>
    ...
    <title>Election Portal::Voting Enable </title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" align="center">Voting Enable/Disable</h1>
      ...
      <form id="voting-enable" action="" role="form" method="post">
                <!--<legend class="text-primary" align="center">Create Booth Form</legend>-->
                      <div class="form-group">
                        ...
                        <button type="submit" name="btnenable" id="btnenable" class="btn-block btn-3d btn-green btn-greenh">Enable</button>
                        </br></br></br>
                      
                      


                        <button type="submit" name="btndisable" id="btndisable" class="btn-block btn-3d btn-red btn-redh">Disable</button>
