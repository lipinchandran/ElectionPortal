<?php
  ...
  if (isset($_POST['oldPass']))
  {
    ...
    $query="select * from where booth_id=$bid";
    $result=mysql_query($query);
    $data=mysql_fetch_array($result);
    $pass=$data['password'];
    if ($oldpassword==$newpassword)
    {
      $updatequery="update booth set password='$newpassword' where booth_id=$bid";
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="">
          <h1 class="page-header" align="center">Booth Setting</h1>
